 ...
 *
 * This container originates with Taylor Otwell's Illuminate packages.
 * It is a core F9 dependency, and so has been imported as unit(s)
 * rather than depend on composer packages.
 *
 * @see     <https://github.com/illuminate/container>
 * @see     <https://laravel.com/api/5.2/Illuminate/Container/Container.html>
 *
...
class Container implements ArrayAccess, ContainerContract
{
    ...
    {
        if ($defaultMethod || $this->isCallableWithAtSign($callback)) {
